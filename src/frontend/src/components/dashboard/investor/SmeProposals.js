        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td>29-05-2020</td>
              <td>In progress</td>
              <td><Link to="/investor/ProjectDetails">Details <svg class="bi bi-box-arrow-up-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <tr>
              ...
              <td>Electronation Nig. Limited</td>
              <td>#10,000,000</td>
              <td>23-5-2020</td>
              <td>Not Started</td>
              <td><Link to="/investor/ProjectDetails">Details <svg class="bi bi-box-arrow-up-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <tr>
              <th scope="row">3</th>
              <td>Cars Sales and Hire</td>
              <td>Moblity Enterprises</td>
              <td>#60,000,000</td>
              <td>02-05-2020</td>
              <td>In Progress</td>
              <td><Link to="/investor/ProjectDetails">Details <svg class="bi bi-box-arrow-up-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <tr>
              <th scope="row">4</th>
              <td>Children Day Care</td>
              <td>Early Birds Care Center</td>
              <td>#3,000,000</td>
              <td>29-04-2020</td>
            ...
            <tr>
              <th scope="row">10</th>
              <td>Leather Manufacturing</td>
              <td>Leather 4all Weather</td>
              <td>3,000,000</td>
              <td>12-03-2020</td>
              <td>Not Started</td>
              <td><Link to="#">Download <svg class="bi bi-box-arrow-up-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" d="M1.5 13A1.5 1.5 0 0 0 3 14.5h8a1.5 1.5 0 0 0 1.5-1.5V9a.5.5 0 0 0-1 0v4a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5V5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 0 0-1H3A1.5 1.5 0 0 0 1.5 5v8zm7-11a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-1 0V2.5H9a.5.5 0 0 1-.5-.5z"/>
              <path fill-rule="evenodd" d="M14.354 1.646a.5.5 0 0 1 0 .708l-8 8a.5.5 0 0 1-.708-.708l8-8a.5.5 0 0 1 .708 0z"/>
              </svg></Link></td>
            </tr>
