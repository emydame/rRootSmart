          ...
          {data.map((item, index, arr) => {
              ...
              return (
                <tr key={index}>
                  ...
                  <td>{item.status}</td>
                  <td>
                    <Link to={`/ProjectDetails/${item.projectId}`}>more details <svg class="bi bi-box-arrow-up-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
